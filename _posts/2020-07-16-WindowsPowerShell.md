...
윈도우즈10/11 환경에서 간단한 명령어로 조금 편하게 쓸 수 있는 기능들을 정리해 본다. 
...
Visual Studio Code를 사용한다면 터미널에서 code $PROFILE 하면 로그인 사용자의 기본 설정파일이 열린다. ( 기본 텍스트 편집도구 노트패드를 사용할 수 있다. notepad.exe $PROFILE )
...
"Set-Alias"로 자신의 명령어를 정의할 수 있다. 아래와 같은 자신만의 명령어를 정의하여 $PROFILE 에 추가한다. 
...
> 유니코드 텍스트는 **Get-Content -Encoding UTF8 .\README.md** 와 같이 인코딩을 설정한다. 
...
-------  ------    -----      -----     ------     --  -- -----------
   2637     120   340672     154236     177.05  22336   1 EXCEL
...
Algorithm       Hash                                Path 
---------       --------------------------------    ---------
MD5             327FD51206F4DA87C368F467B067A73F    README.md

❯ Get-FileHash -Algorithm sha256 .\README.md

Algorithm       Hash                                Path
---------       ----------------------------        ----
SHA256          88F9ED20AB1ACDC0C8699A63174903C994670AEEB67B1725E147A937E8236B78       README.md
```
