...
> **[2026-07-15 업데이트]** Notionlytics는 지금도 운영 중이며 요금제는 Pro($10/월), Team($30/월), Business($90/월)로 바뀌었다(당시의 Starter/Creator 구분은 없어졌다). 본문의 구글 애널리틱스 연동 설명은 **유니버설 애널리틱스(UA)** 기준인데, UA는 2023년 7월에 데이터 수집이 종료되어 현재는 **GA4** 기준으로 연동 화면과 속성 생성 방식이 다르므로 참고만 한다.
...
> *(2026-07 주석)* 현재 요금제는 Pro / Team / Business 3단계로 개편되었다.
...
> *(2026-07 주석)* 이 화면은 유니버설 애널리틱스(UA) 기준이다. UA는 2023년 7월 종료되었고 현재는 GA4 속성으로 연동되므로 실제 화면과 속성 구조가 다르다.
