...
>
> - **쿼터 인식 스케줄링(Quota-Share)과 쿼터 텔레메트리** — 무료 티어 잔량을 보고 분배한다. [에이전트 스택 글]({{site.baseurl}}/tools/2026/09/11/opensource-agent-stack.html)에서 겪은 "프로바이더가 403으로 막혀도 조용히 폴백돼 엉뚱한 모델이 답하는" 문제에 대응할 여지가 생겼다.
