...
> **[2026-07-15 업데이트]** Vundle과 vial-http 모두 유지보수가 중단되었다. 현재는 vim-plug나 lazy.nvim 같은 플러그인 매니저와 rest.nvim(Neovim)을 쓰거나, VS Code의 REST Client 확장이 대안이다. VS Code REST Client 사용법은 [REST Client for Visual Studio Code]({{site.baseurl}}/tools/2023/07/22/restclient.html) 글을 참고한다.
